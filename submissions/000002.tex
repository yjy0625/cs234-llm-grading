...
\begin{enumerate}[label=(\alph*)]
    ...
    %%%%% Start of 1(a) %%%%%
	No. The agent can only take one unique action at a step, so it's impossible for an optimal policy to both buy and sell at a particular step.
    %%%%% End of 1(a) %%%%%
    \end{tcolorbox}
    \newpage
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 1(b) %%%%%
	No. Since the agent gets a very high reward +100 when it fully stocks the inventory, the optimal policy will always terminate when reaching a +100 reward.
    %%%%% End of 1(b) %%%%%
    \end{tcolorbox}
    \newpage
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 1(d) %%%%%
	Yes. There always exists $\gamma = 0$ such that the optimal policy is the same as an MDP with finite horizon $H$. This is because when $\gamma = 0$ the optimal policy is the same as the MDP with finite horizon $H = 1$.
    %%%%% End of 1(d) %%%%%
    \end{tcolorbox}
    \newpage
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 2(a) %%%%%
	The AI car doesn't merge because it is blocked by the gray ones and the transition function doesn't allow it to merge within reasonable horizon.
    %%%%% End of 2(a) %%%%%
    \end{tcolorbox}
    \newpage
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 2(b) %%%%%
    One possible way is to terminate the episode if the AI car is at zero velocity. This termination can motivate the policy to move the AI car and prevent it from staying halted. Another way is to give a high success reward when all cars get non-zero speed.
    %%%%% End of 2(b) %%%%%
    \end{tcolorbox}
    \newpage
