...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 1(b) %%%%%
	Yes. If $\gamma$ is sufficiently small, the agent will not be motivated to stock up for the +100 reward and will sell whenever possible.
    %%%%% End of 1(b) %%%%%
    \end{tcolorbox}
    \newpage
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 1(d) %%%%%
	No. There doesn't always exist such a $\gamma$.
    %%%%% End of 1(d) %%%%%
    \end{tcolorbox}
    \newpage
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 2(a) %%%%%
	Since when AI car merges into the highway, the average speed of cars is smaller than if the car doesn't merge and stays at zero speed, the optimal policy chooses not to merge.
    %%%%% End of 2(a) %%%%%
    \end{tcolorbox}
    \newpage
    ...
    \begin{tcolorbox}[breakable]
    %%%%% Start of 2(b) %%%%%
    One could design auxiliary reward terms that give penalties when speed of any car is lower than a speed threshold. The reward could also be the speed of the slowest car instead of the mean speed of all cars. This prevents the AI car from "giving up" from merging.
    %%%%% End of 2(b) %%%%%
    \end{tcolorbox}
    \newpage
